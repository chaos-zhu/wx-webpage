<template>
    <div>
			<alert v-model="show" :title="'Tips'">
				...
				<!-- 在开发模式已开启wx.config的debug模式选项<br><br>
				因此测试JS-SDK过程中可能会出现操作提示弹窗<br> -->
			</alert>
			<box gap="10px 10px">
				...
				<x-button :gradients="['#FF5E3A', '#FF9500']" @click.native="closeWindow">关闭网页</x-button>
				<x-button :disabled='false' @click.native="scanQRCode">调用扫一扫(无权限)</x-button>
				<x-button @click.native="closeWindow">关闭网页</x-button>
